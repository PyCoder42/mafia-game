...
- [ ] **E1. Night turn order leaks roles** (item 10)
...
- [ ] **E2. "Someone was found dead during role reveal"** (item 11)
...
- [ ] **E3. In-game `?` button does nothing** (item 12)
...
- [ ] **E4. Hosting requires a second pointless click** (item 1)
...
- [ ] **E5. Mobile chat blocks the UI + chat not always available** (item 3)
...
- [ ] **E6. No reconnect/leave handling** (item 4)
...
- [ ] **E7. Map hint arrow finicky/ugly on mobile** (item 5)
...
- [ ] **E8. Mafia risk not separated from town exposure** (items 6+8)
...
- [ ] **E10. Lazy room detail strings** (item 9)
...
- [ ] Mobile pass at 390×844: lobby, evening cards, night consoles, chat drawer, map modal, fullscreen QR, tutorial.
- [ ] ≥3 full games in a real browser (plus sweep + 10-run matrix + live-site re-verify).
